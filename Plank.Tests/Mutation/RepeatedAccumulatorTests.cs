...
public class RepeatedAccumulatorTests
{
    ...
    public void IntList_MinInMiddle_StatisticsCorrect()
    {
        ...
        ClassicAssert.AreEqual(ColumnStatistics.ColumnStatisticsValueKind.Int32, c.Statistics.ValueKind);
        ClassicAssert.AreEqual(3L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(20L, c.Statistics.MaxBits);
    }
    ...
    public void IntList_MaxInFirst_StatisticsCorrect()
    {
        ...
        ClassicAssert.AreEqual(5L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(100L, c.Statistics.MaxBits);
    }
    ...
    public void IntList_AllSameValue_DistinctCountIsOne()
    {
        ...
        ClassicAssert.AreEqual(7L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(7L, c.Statistics.MaxBits);
        ClassicAssert.AreEqual(1L, c.Statistics.DistinctCount);
    }
    ...
    public void IntList_NegativeValues_CorrectMinMax()
    {
        ...
        ClassicAssert.AreEqual(-10L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(15L, c.Statistics.MaxBits);
    }
    ...
    public void IntList_SingleElement_MinEqualsMax()
    {
        ...
        ClassicAssert.AreEqual(42L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(42L, c.Statistics.MaxBits);
    }
    ...
    public void LongList_MinInMiddle_StatisticsCorrect()
    {
        ...
        ClassicAssert.AreEqual(ColumnStatistics.ColumnStatisticsValueKind.Int64, c.Statistics.ValueKind);
        ClassicAssert.AreEqual(10L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(200L, c.Statistics.MaxBits);
    }
    ...
    public void FloatList_MinMaxCorrect()
    {
        ...
        ClassicAssert.AreEqual(ColumnStatistics.ColumnStatisticsValueKind.Float, c.Statistics.ValueKind);
        ClassicAssert.AreEqual(-2.0f, BitConverter.Int32BitsToSingle((int)c.Statistics.MinBits));
        ClassicAssert.AreEqual(5.0f, BitConverter.Int32BitsToSingle((int)c.Statistics.MaxBits));
    }
    ...
    public void FloatList_IgnoresNaN()
    {
        ...
        ClassicAssert.AreEqual(1.0f, BitConverter.Int32BitsToSingle((int)c.Statistics.MinBits));
        ClassicAssert.AreEqual(3.0f, BitConverter.Int32BitsToSingle((int)c.Statistics.MaxBits));
    }
    ...
    public void DoubleList_MinMaxCorrect()
    {
        ...
        ClassicAssert.AreEqual(-5.0, BitConverter.Int64BitsToDouble(c.Statistics.MinBits));
        ClassicAssert.AreEqual(20.0, BitConverter.Int64BitsToDouble(c.Statistics.MaxBits));
    }
    ...
    public void BoolList_AllTrue_MinAndMaxTrue()
    {
        ...
        ClassicAssert.AreEqual(ColumnStatistics.ColumnStatisticsValueKind.Boolean, c.Statistics.ValueKind);
        ClassicAssert.AreEqual(1L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(1L, c.Statistics.MaxBits);
    }
    ...
    public void BoolList_Mixed_MinFalseMaxTrue()
    {
        ...
        ClassicAssert.AreEqual(0L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(1L, c.Statistics.MaxBits);
    }
    ...
    public void BoolList_FirstInRow_InitializesMinMax()
    {
        ...
        ClassicAssert.AreEqual(0L, c.Statistics.MinBits);  // min = false
        ClassicAssert.AreEqual(1L, c.Statistics.MaxBits);   // max = true
    }
    ...
    public void RequiredInt32_Statistics_HasStatistics()
    {
        ...
        ClassicAssert.IsTrue(c.Statistics.HasStatistics);
        ClassicAssert.AreEqual(1L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(10L, c.Statistics.MaxBits);
    }
    ...
    public void RequiredFloat_Statistics_Correct()
    {
        ...
        ClassicAssert.AreEqual(ColumnStatistics.ColumnStatisticsValueKind.Float, c.Statistics.ValueKind);
        ClassicAssert.AreEqual(1.5f, BitConverter.Int32BitsToSingle((int)c.Statistics.MinBits));
        ClassicAssert.AreEqual(7.0f, BitConverter.Int32BitsToSingle((int)c.Statistics.MaxBits));
    }
    ...
    public void RequiredDouble_Statistics_Correct()
    {
        ...
        ClassicAssert.AreEqual(ColumnStatistics.ColumnStatisticsValueKind.Double, c.Statistics.ValueKind);
        ClassicAssert.AreEqual(1.5, BitConverter.Int64BitsToDouble(c.Statistics.MinBits));
        ClassicAssert.AreEqual(7.0, BitConverter.Int64BitsToDouble(c.Statistics.MaxBits));
    }
    ...
    public void RequiredLong_Statistics_Correct()
    {
        ...
        ClassicAssert.AreEqual(50L, c.Statistics.MinBits);
        ClassicAssert.AreEqual(200L, c.Statistics.MaxBits);
    }
