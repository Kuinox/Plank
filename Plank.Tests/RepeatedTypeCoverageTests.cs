...
internal sealed class RepeatedTypeCoverageTests
{
    ...
    public async Task RepeatedBooleanRoundTrips()
    {
        ...
        try
        {
            ...
            using (var writer = ParquetWriter.Create(stream, schema))
            {
                ...
                await rowGroup.WriteAsync(schema.Columns[0], new RepeatedValues<bool>(rows)).ConfigureAwait(false);
                writer.CloseFile();
            }
    ...
    public async Task RepeatedFloatRoundTrips()
    {
        ...
        try
        {
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(schema.Columns[0], new RepeatedValues<float>(rows)).ConfigureAwait(false);
                writer.CloseFile();
            }
    ...
    public async Task RepeatedDoubleRoundTrips()
    {
        ...
        try
        {
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(schema.Columns[0], new RepeatedValues<double>(rows)).ConfigureAwait(false);
                writer.CloseFile();
            }
    ...
    public async Task RepeatedInt64RoundTrips()
    {
        ...
        try
        {
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(schema.Columns[0], new RepeatedValues<long>(rows)).ConfigureAwait(false);
                writer.CloseFile();
            }
    ...
    public async Task RepeatedByteArrayRoundTrips()
    {
        ...
        try
        {
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(schema.Columns[0], new RepeatedValues<byte[]>(rows)).ConfigureAwait(false);
                writer.CloseFile();
            }
    ...
    public async Task RepeatedDateOnlyAndTimeOnlyAreReadableByParquetSharp()
    {
        ...
        try
        {
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(dateSchema.Columns[0], new RepeatedValues<DateOnly>(dateRows)).ConfigureAwait(false);
                writer.CloseFile();
            }
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(timeSchema.Columns[0], new RepeatedValues<TimeOnly>(timeRows)).ConfigureAwait(false);
                writer.CloseFile();
            }
    ...
    public async Task RepeatedDateTimeAndDateTimeOffsetAreReadableByParquetSharp()
    {
        ...
        try
        {
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(schema.Columns[0], new RepeatedValues<DateTime>(dateTimeRows)).ConfigureAwait(false);
                writer.CloseFile();
            }
            ...
            {
                var rowGroup = writer.StartRowGroup();
                await rowGroup.WriteAsync(schema.Columns[0], new RepeatedValues<DateTimeOffset>(dtoRows)).ConfigureAwait(false);
                writer.CloseFile();
            }
