...
internal sealed class ParquetReaderRobustnessTests
{
    ...
    [Test]
    [TestCase("ByteStreamSplitInt32PayloadTooShort.parquet")]
    [TestCase("ColumnCountExceedsRemainingInput.parquet")]
    [TestCase("crash-001.parquet")]
    [TestCase("DefinitionLevelLiteralByteCountExceedsPayload.parquet")]
    [TestCase("DefinitionLevelLiteralGroupCountTooLarge.parquet")]
    [TestCase("DictionaryIndexesNullsOutOfBounds.parquet")]
    [TestCase("DictionaryLiteralRunBeforeRleRun.parquet")]
    [TestCase("DictionaryPageValueCountExceedsPayload.parquet")]
    [TestCase("NegativeCompressedPageSize.parquet")]
    [TestCase("NegativeI64OffsetInFooter.parquet")]
    [TestCase("PlainDoublePayloadTooShort.parquet")]
    [TestCase("PlainInt32PayloadTooShort.parquet")]
    [TestCase("PlainInt64PayloadTooShort.parquet")]
    [TestCase("RleBitPackedHybridZeroBitWidth.parquet")]
    [TestCase("RowGroupCountOverflow.parquet")]
    [TestCase("SnappyDestinationTooSmall.parquet")]
    [TestCase("ThriftNestingDepthExceedsMaximum.parquet")]
