...
public class ColumnStatisticsVectorizedTests
{
    ...
    public void Double_MinInSecondLane_CorrectMinMax()
    {
        ...
        ClassicAssert.AreEqual(7.0, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Double_MaxInThirdLane_CorrectMinMax()
    {
        ...
        var s = ColumnStatistics.Create(DoubleCol(), values, 0);
        ClassicAssert.AreEqual(1.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual(10.0, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Double_MinInLastLane_CorrectMinMax()
    {
        ...
        var s = ColumnStatistics.Create(DoubleCol(), values, 0);
        ClassicAssert.AreEqual(1.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual(5.0, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Double_MaxInLastLane_CorrectMinMax()
    {
        ...
        var s = ColumnStatistics.Create(DoubleCol(), values, 0);
        ClassicAssert.AreEqual(2.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual(100.0, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Double_TailHasMin_CorrectMinMax()
    {
        ...
        var s = ColumnStatistics.Create(DoubleCol(), values, 0);
        ClassicAssert.AreEqual(-999.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual(5.0, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Double_TailHasMax_CorrectMinMax()
    {
        ...
        var s = ColumnStatistics.Create(DoubleCol(), values, 0);
        ClassicAssert.AreEqual(2.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual(999.0, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Double_MultipleVectorBlocks_CorrectMinMax()
    {
        ...
        var s = ColumnStatistics.Create(DoubleCol(), values, 0);
        ClassicAssert.AreEqual(-50.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual((double)((width * 2 - 1) * 2), BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Double_ExactlyVectorWidth_CorrectMinMax()
    {
        ...
        var s = ColumnStatistics.Create(DoubleCol(), values, 0);
        ClassicAssert.AreEqual(1.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual((double)width, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
    ...
    public void Int32_MinInNonFirstLane_Vectorized()
    {
        ...
        ClassicAssert.AreEqual(-999L, s.MinBits);
    ...
    public void Int32_LargeVectorized_CorrectMinMax()
    {
        ...
        values[99] = 5000;
        var s = ColumnStatistics.Create(Int32Col(), values, 0);
        ClassicAssert.AreEqual(-1000L, s.MinBits);
        ClassicAssert.AreEqual(5000L, s.MaxBits);
    }
    ...
    public void Float_MinInNonFirstLane_Vectorized()
    {
        ...
        ClassicAssert.AreEqual(-99.0f, BitConverter.Int32BitsToSingle((int)s.MinBits));
    }
    ...
    public void Float_TailHasMin_Vectorized()
    {
        ...
        values[width] = -100.0f;
        var s = ColumnStatistics.Create(FloatCol(), values, 0);
        ClassicAssert.AreEqual(-100.0f, BitConverter.Int32BitsToSingle((int)s.MinBits));
    ...
    public void NullableFloat_LargeInput_VectorizedDensification()
    {
        ...
        ClassicAssert.AreEqual(0.0f, BitConverter.Int32BitsToSingle((int)s.MinBits));
        ClassicAssert.AreEqual(299.0f, BitConverter.Int32BitsToSingle((int)s.MaxBits));
    ...
    public void NullableFloat_ExactlyAt256Boundary_Stackalloc()
    {
        ...
        var s = ColumnStatistics.CreateOptional<float>(FloatCol(), values.AsSpan());
        ClassicAssert.AreEqual(0.0f, BitConverter.Int32BitsToSingle((int)s.MinBits));
        ClassicAssert.AreEqual(255.0f, BitConverter.Int32BitsToSingle((int)s.MaxBits));
    }
    ...
    public void NullableDouble_LargeInput_VectorizedDensification()
    {
        ...
        ClassicAssert.AreEqual(0.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual(299.0, BitConverter.Int64BitsToDouble(s.MaxBits));
        ClassicAssert.AreEqual(1L, s.NullCount);
    }
    ...
    public void NullableDouble_ExactlyAt256_Stackalloc()
    {
        ...
        var s = ColumnStatistics.CreateOptional<double>(DoubleCol(), values.AsSpan());
        ClassicAssert.AreEqual(0.0, BitConverter.Int64BitsToDouble(s.MinBits));
        ClassicAssert.AreEqual(255.0, BitConverter.Int64BitsToDouble(s.MaxBits));
    }
}
