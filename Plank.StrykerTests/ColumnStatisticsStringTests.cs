...
public class ColumnStatisticsStringTests
{
    ...
    public void OptionalByteArray_FirstMinThenMax_CorrectMinMax()
    {
        ...
        Assert.Equal(new byte[] { 9, 0 }, s.MaxValue?.Take(s.MaxValueLength).ToArray());
    }
    ...
    public void OptionalByteArray_SingleNonNull_MinEqualsMax()
    {
        ...
        Assert.Equal(42, s.MinValue![0]);
        Assert.Equal(42, s.MaxValue![0]);
    ...
    public void OptionalByteArray_ShorterPrefixIsSmaller()
    {
        ...
        var s = ColumnStatistics.CreateOptional<byte[]>(ByteArrayCol(), values.AsSpan());
        Assert.Equal(1, s.MinValueLength);
        Assert.Equal(new byte[] { 1 }, s.MinValue?.Take(s.MinValueLength).ToArray());
    }
    ...
    public void OptionalString_FirstMinThenMax_CorrectMinMax()
    {
        ...
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("alpha"), minBytes);
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("gamma"), maxBytes);
    }
    ...
    public void OptionalString_SingleNonNull_MinEqualsMax()
    {
        ...
        Assert.Equal(expected, s.MinValue?.Take(s.MinValueLength).ToArray());
        Assert.Equal(expected, s.MaxValue?.Take(s.MaxValueLength).ToArray());
        Assert.Equal(1L, s.DistinctCount); // same min and max → distinct=1
        Assert.Equal(2L, s.NullCount);
    }
    ...
    public void OptionalString_Ascending_MinIsFirst()
    {
        ...
        var s = ColumnStatistics.CreateOptional<string>(StringCol(), values.AsSpan());
        Assert.Equal(new byte[] { 0x61 }, s.MinValue?.Take(s.MinValueLength).ToArray()); // "a"
        Assert.Equal(new byte[] { 0x64 }, s.MaxValue?.Take(s.MaxValueLength).ToArray()); // "d"
    }
    ...
    public void OptionalString_Descending_MinIsLast()
    {
        ...
        var s = ColumnStatistics.CreateOptional<string>(StringCol(), values.AsSpan());
        Assert.Equal(new byte[] { 0x61 }, s.MinValue?.Take(s.MinValueLength).ToArray()); // "a"
        Assert.Equal(new byte[] { 0x7a }, s.MaxValue?.Take(s.MaxValueLength).ToArray()); // "z"
    }
    ...
    public void String_NonAsciiComparison_CorrectOrder()
    {
        ...
        var minBytes = s.MinValue?.Take(s.MinValueLength).ToArray();
        var maxBytes = s.MaxValue?.Take(s.MaxValueLength).ToArray();
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("cafe"), minBytes);
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("café"), maxBytes);
    }
    ...
    public void String_DifferentLengths_ShorterLexicographicWins()
    {
        ...
        var s = ColumnStatistics.Create(StringCol(), values, 0);
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("ab"), s.MinValue?.Take(s.MinValueLength).ToArray());
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("abc"), s.MaxValue?.Take(s.MaxValueLength).ToArray());
    }
    ...
    public void CreateStringWithBuffers_MinInMiddle_CorrectMinMax()
    {
        ...
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("alpha"), s.MinValue?.Take(s.MinValueLength).ToArray());
        Assert.Equal(System.Text.Encoding.UTF8.GetBytes("gamma"), s.MaxValue?.Take(s.MaxValueLength).ToArray());
    }
    ...
    public void CreateByteArray_MinInMiddle_CorrectMinMax()
    {
        ...
        Assert.Equal(new byte[] { 5 }, s.MinValue?.Take(s.MinValueLength).ToArray());
        Assert.Equal(new byte[] { 20 }, s.MaxValue?.Take(s.MaxValueLength).ToArray());
    }
    ...
    public void CreateByteArrayWithReusableBuffers_RoundTrip()
    {
        ...
        Assert.Equal(new byte[] { 1 }, s.MinValue?.Take(s.MinValueLength).ToArray());
        Assert.Equal(new byte[] { 9 }, s.MaxValue?.Take(s.MaxValueLength).ToArray());
        Assert.NotNull(minBuf);
        Assert.NotNull(maxBuf);
    }
}
