...
public class DefaultStrategyTests
{
    ...
    public void Plain_DictionaryMode_IsDisabled()
    {
        ...
        Assert.Equal(DictionaryMode.Disabled, s.GetDictionaryMode());
    }
    ...
    public void RleDictionary_DictionaryMode_IsMaybe()
    {
        ...
        Assert.Equal(DictionaryMode.Maybe, s.GetDictionaryMode());
    }
    ...
    {
        var s = MakeDictStrategy();
        Assert.Equal(DictionarySortOrder.Unknown, s.GetDictionarySortOrder());
    }
    ...
    public void SetSortOrder_Ascending_RoundTrips()
    {
        ...
        Assert.Equal(DictionarySortOrder.Ascending, s.GetDictionarySortOrder());
    }
    ...
    public void SetSortOrder_Unsorted_RoundTrips()
    {
        ...
        Assert.Equal(DictionarySortOrder.Unsorted, s.GetDictionarySortOrder());
    }
    ...
    public void SetSortOrder_Descending_RoundTrips()
    {
        ...
        Assert.Equal(DictionarySortOrder.Descending, s.GetDictionarySortOrder());
    }
    ...
    {
        var s = MakeDictStrategy();
        Assert.False(s.ShouldDropDictionary(100, 1000, rowsSeen: 0));
    }
    ...
    {
        var s = MakeDictStrategy();
        Assert.False(s.ShouldDropDictionary(100, totalRowCount: 0, rowsSeen: 1000));
    }
    ...
    public void ShouldDropDictionary_TooFewRowsSeen_ReturnsFalse()
    {
        ...
        var s = MakeDictStrategy();
        Assert.False(s.ShouldDropDictionary(500, totalRowCount: 100_000, rowsSeen: 1_000));
    }
    ...
    public void ShouldDropDictionary_AllUnique_ReturnsTrue()
    {
        ...
        var s = MakeDictStrategy();
        Assert.True(s.ShouldDropDictionary(uniqueCount: 20_000, totalRowCount: 100_000, rowsSeen: 20_000));
    }
    ...
    public void ShouldDropDictionary_OneUnique_ReturnsFalse()
    {
        ...
        var s = MakeDictStrategy();
        Assert.False(s.ShouldDropDictionary(uniqueCount: 1, totalRowCount: 100_000, rowsSeen: 50_000));
    }
    ...
    public void ShouldDropDictionary_LowCardinality_ReturnsFalse()
    {
        ...
        var s = MakeDictStrategy();
        Assert.False(s.ShouldDropDictionary(uniqueCount: 100, totalRowCount: 100_000, rowsSeen: 50_000));
    }
    ...
    public void ShouldDropDictionary_NearlyAllUnique_ReturnsTrue()
    {
        ...
        var s = MakeDictStrategy();
        Assert.True(s.ShouldDropDictionary(uniqueCount: 49_000, totalRowCount: 100_000, rowsSeen: 50_000));
    }
    ...
    public void ShouldDropDictionary_HighProjectedCardinality_ReturnsTrue()
    {
        ...
        var s = MakeDictStrategy();
        Assert.True(s.ShouldDropDictionary(uniqueCount: 42_500, totalRowCount: 100_000, rowsSeen: 50_000));
    }
    ...
    public void ShouldDropDictionary_RowsSeenEqualsTotal_SkipsDecisionThresholdCheck()
    {
        ...
        var s = MakeDictStrategy();
        Assert.False(s.ShouldDropDictionary(uniqueCount: 50, totalRowCount: 100, rowsSeen: 100));
    }
    ...
    public void TryGetTargetDataPageSizeBytes_ReturnsConfiguredValue()
    {
        ...
        Assert.True(s.TryGetTargetDataPageSizeBytes(out var size));
        Assert.Equal(65536u, size);
    }
    ...
    {
        var s = MakeStrategy();
        Assert.False(s.ShouldStartNewDataPage(1000, 500, 500));
        Assert.False(s.ShouldStartNewDataPage(0, 0, 0));
        Assert.False(s.ShouldStartNewDataPage(1, 1, 1));
    }
}
