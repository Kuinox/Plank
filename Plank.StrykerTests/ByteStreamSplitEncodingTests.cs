...
public class ByteStreamSplitEncodingTests
{
    ...
    public void WriteInt32_SingleValue_FourBytesInLanes()
    {
        ...
        Assert.Equal(0x04, encoded[0]); // lane0 (LSB)
        Assert.Equal(0x03, encoded[1]); // lane1
        Assert.Equal(0x02, encoded[2]); // lane2
        Assert.Equal(0x01, encoded[3]); // lane3 (MSB)
    }
    ...
    public void WriteInt32_TwoValues_LaneInterleaved()
    {
        ...
        Assert.Equal(0x04, encoded[0]); // lane0[0]
        Assert.Equal(0x08, encoded[1]); // lane0[1]
        Assert.Equal(0x03, encoded[2]); // lane1[0]
        Assert.Equal(0x07, encoded[3]); // lane1[1]
        Assert.Equal(0x02, encoded[4]); // lane2[0]
        Assert.Equal(0x06, encoded[5]); // lane2[1]
        Assert.Equal(0x01, encoded[6]); // lane3[0]
        Assert.Equal(0x05, encoded[7]); // lane3[1]
    }
    ...
    public void WriteInt32_AllFF_AllBytesFF()
    {
        ...
        Assert.Equal(4, encoded.Length);
        Assert.All(encoded, b => Assert.Equal(0xFF, b));
    }
    ...
    public void WriteInt32_ByteValues_LowByteInLane0_HighLanesZero()
    {
        ...
        Assert.Equal(8, encoded.Length); // 2 values × 4 bytes
        // lane0: [0x42, 0xFF], lanes 1-3: [0x00, 0x00]
        Assert.Equal(0x42, encoded[0]); // lane0[0]
        Assert.Equal(0xFF, encoded[1]); // lane0[1]
        Assert.Equal(0x00, encoded[2]); // lane1[0]
        Assert.Equal(0x00, encoded[3]); // lane1[1]
        Assert.Equal(0x00, encoded[4]); // lane2[0]
        Assert.Equal(0x00, encoded[5]); // lane2[1]
        Assert.Equal(0x00, encoded[6]); // lane3[0]
        Assert.Equal(0x00, encoded[7]); // lane3[1]
    }
    ...
    public void WriteInt32_ByteValues_Single()
    {
        ...
        Assert.Equal(4, encoded.Length);
        Assert.Equal(200, encoded[0]);   // lane0 = byte value
        Assert.Equal(0, encoded[1]);     // lane1 = 0 (high bits)
    ...
    public void WriteInt32_UShortValues_TwoLanesUsed()
    {
        ...
        Assert.Equal(0x04, encoded[1]);
        // lane1: [0x01, 0x03]
        Assert.Equal(0x01, encoded[2]);
        Assert.Equal(0x03, encoded[3]);
        // lanes 2-3: all zeros
    ...
    public void WriteInt32_UShortMax_CorrectLanes()
    {
        ...
        Assert.Equal(4, encoded.Length);
        Assert.Equal(0xFF, encoded[0]); // lane0
        Assert.Equal(0xFF, encoded[1]); // lane1
        Assert.Equal(0x00, encoded[2]); // lane2 = 0 (ushort has no high 16 bits)
        Assert.Equal(0x00, encoded[3]); // lane3 = 0
    }
    ...
    public void WriteInt64_SingleValue_EightBytesInLanes()
    {
        ...
        Assert.Equal(8, encoded.Length);
        Assert.Equal(0x08, encoded[0]); // lane0 (LSB)
        Assert.Equal(0x07, encoded[1]); // lane1
        Assert.Equal(0x06, encoded[2]); // lane2
        Assert.Equal(0x05, encoded[3]); // lane3
        Assert.Equal(0x04, encoded[4]); // lane4
        Assert.Equal(0x03, encoded[5]); // lane5
        Assert.Equal(0x02, encoded[6]); // lane6
        Assert.Equal(0x01, encoded[7]); // lane7 (MSB)
    }
    ...
    public void WriteInt64_TwoValues_LaneInterleaved()
    {
        ...
        // lane7: [0x01, 0x09]
        Assert.Equal(0x01, encoded[14]);
        Assert.Equal(0x09, encoded[15]);
    }
    ...
    public void WriteInt64_ULongValues_EightLanes()
    {
        ...
        Assert.Equal(8, encoded.Length);
        Assert.Equal(0x08, encoded[0]); // lane0
        Assert.Equal(0x07, encoded[1]); // lane1
        Assert.Equal(0x01, encoded[7]); // lane7
    }
    ...
    public void WriteFloat_TwoValues_EightBytes()
    {
        ...
        Assert.Equal(8, encoded.Length); // 2 × 4 bytes
    }
    ...
    public void WriteDouble_TwoValues_SixteenBytes()
    {
        ...
        Assert.Equal(16, encoded.Length); // 2 × 8 bytes
    }
    ...
    public void WriteFixedLen_SingleValue_LaneInterleaved()
    {
        ...
        Assert.Equal(4, encoded.Length);
        Assert.Equal(0x01, encoded[0]); // lane0
        Assert.Equal(0x02, encoded[1]); // lane1
        Assert.Equal(0x03, encoded[2]); // lane2
        Assert.Equal(0x04, encoded[3]); // lane3
    }
    ...
    public void WriteFixedLen_TwoValues_LaneInterleaved()
    {
        ...
        Assert.Equal(4, encoded.Length); // 2 values × 2 bytes
