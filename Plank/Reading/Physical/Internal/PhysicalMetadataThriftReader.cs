...
static class PhysicalMetadataThriftReader
{
    ...
    static (LogicalTypeInfo LogicalType, NodeKind Annotation) ReadConvertedType(int convertedType,
        ...
        => convertedType switch
        {
            ...
            8 => (new LogicalTypeInfo(LogicalTypeKind.Time, Unit: TimeUnit.Micros, IsAdjustedToUtc: true), NodeKind.Group),
            9 => (new LogicalTypeInfo(LogicalTypeKind.Timestamp, Unit: TimeUnit.Millis, IsAdjustedToUtc: true), NodeKind.Group),
            10 => (new LogicalTypeInfo(LogicalTypeKind.Timestamp, Unit: TimeUnit.Micros, IsAdjustedToUtc: true), NodeKind.Group),
