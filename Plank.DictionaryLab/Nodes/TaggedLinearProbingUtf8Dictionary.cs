...
public sealed class TaggedLinearProbingUtf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    public static string ExperimentName => "hash.linear.tagged.v1";

    public static Type? ParentExperimentType => typeof(LinearProbingUtf8Dictionary);

    public static string ExperimentDescription => "UTF-8 linear probing plus one-byte hash tags.";
