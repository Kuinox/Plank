...
public sealed class TaggedLinearProbingUltraSparseTunedLengthPrefilterStringDictionary : IExperimentDictionary<string>
{
    ...
    public static string ExperimentDescription => "Tagged ultra-sparse tuned probing with per-slot length prefilter before string equality.";
