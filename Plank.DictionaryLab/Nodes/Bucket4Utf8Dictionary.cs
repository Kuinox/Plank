...
public sealed class Bucket4Utf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    public static string ExperimentName => "hash.bucket4.v1";

    public static Type? ParentExperimentType => null;

    public static string ExperimentDescription => "UTF-8 4-slot bucketized probing with bucket-wise scans before advancing.";
