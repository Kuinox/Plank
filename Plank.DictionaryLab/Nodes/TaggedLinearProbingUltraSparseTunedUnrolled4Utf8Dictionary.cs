...
public sealed class TaggedLinearProbingUltraSparseTunedUnrolled4Utf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    ...
    public static string ExperimentDescription => "UTF-8 tagged ultra-sparse tuned probing with 4-step unrolled probe loop to reduce branch overhead.";
