...
public sealed class TaggedHalfLoadTouchedStringDictionary : IExperimentDictionary<string>
{
    public static string ExperimentName => "hash.linear.tagged.half-load.touched.v1";

    public static Type? ParentExperimentType => typeof(TaggedLinearProbingHalfLoadStringDictionary);

    public static string ExperimentDescription => "Tagged half-load linear probing with touched reset.";
