...
public sealed class TaggedLinearProbingHalfLoadUtf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    public static string ExperimentName => "hash.linear.tagged.half-load.v1";

    public static Type? ParentExperimentType => typeof(TaggedLinearProbingUtf8Dictionary);

    public static string ExperimentDescription => "UTF-8 tagged linear probing with 50% max load.";
