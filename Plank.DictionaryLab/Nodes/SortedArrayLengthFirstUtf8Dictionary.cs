...
public sealed class SortedArrayLengthFirstUtf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    ...
    public static string ExperimentDescription => "UTF-8 sorted array branch with length metadata short-circuiting compare.";
