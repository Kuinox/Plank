...
public sealed class RobinHoodTaggedStringDictionary : IExperimentDictionary<string>
{
    public static string ExperimentName => "hash.robinhood.tagged.v1";

    public static Type? ParentExperimentType => typeof(RobinHoodStringDictionary);

    public static string ExperimentDescription => "Robin Hood probing with one-byte tag fingerprint.";
