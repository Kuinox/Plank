...
public sealed class TaggedLinearProbingStringDictionary : IExperimentDictionary<string>
{
    ...
    public static string ExperimentDescription => "Linear probing plus one-byte hash fingerprint tags.";
