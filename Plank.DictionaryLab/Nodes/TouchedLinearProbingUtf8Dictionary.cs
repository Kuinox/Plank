...
public sealed class TouchedLinearProbingUtf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    public static string ExperimentName => "hash.linear.touched-reset.v1";

    public static Type? ParentExperimentType => typeof(LinearProbingUtf8Dictionary);

    public static string ExperimentDescription => "UTF-8 linear probing with touched-slot reset.";
    ...
    public sealed class Tagged : IExperimentDictionary<ReadOnlyMemory<byte>>
    {
        public static string ExperimentName => "hash.linear.touched-reset.tagged.v1";

        public static Type? ParentExperimentType => typeof(TouchedLinearProbingUtf8Dictionary);

        public static string ExperimentDescription => "UTF-8 linear probing with touched-slot reset and one-byte hash tags.";
        ...
        public sealed class HalfLoad : IExperimentDictionary<ReadOnlyMemory<byte>>
        {
            public static string ExperimentName => "hash.linear.touched-reset.tagged.half-load.v1";

            public static Type? ParentExperimentType => typeof(Tagged);

            public static string ExperimentDescription => "UTF-8 linear probing with touched-slot reset, one-byte tags, and 50% max load.";
