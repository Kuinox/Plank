...
public sealed class TaggedLinearProbingSparseStringDictionary : IExperimentDictionary<string>
{
    ...
    public static string ExperimentDescription => "Tagged linear probing with 35% max load.";
