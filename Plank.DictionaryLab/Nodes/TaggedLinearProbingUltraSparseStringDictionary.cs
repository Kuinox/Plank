...
public sealed class TaggedLinearProbingUltraSparseStringDictionary : IExperimentDictionary<string>
{
    public static string ExperimentName => "hash.linear.tagged.ultra-sparse.v1";

    public static Type? ParentExperimentType => typeof(TaggedLinearProbingSparseStringDictionary);

    public static string ExperimentDescription => "Tagged linear probing with 25% max load.";
    ...
    public sealed class Tuned : IExperimentDictionary<string>
    {
        ...
        public static string ExperimentDescription => "Tagged ultra-sparse probing tuned for tag-first branch behavior.";
        ...
        public sealed class Touched : IExperimentDictionary<string>
        {
            ...
            public static string ExperimentDescription => "Tagged ultra-sparse tuned probing with touched-slot reset to avoid full clears.";
            ...
            public sealed class Fingerprinted : IExperimentDictionary<string>
            {
                ...
                public static string ExperimentDescription => "Tagged ultra-sparse tuned touched probing with a 16-bit fingerprint prefilter before full key compare.";
        ...
        public sealed class Fingerprint16 : IExperimentDictionary<string>
        {
            public static string ExperimentName => "hash.linear.tagged.ultra-sparse.tuned.fingerprint16.v1";

            public static Type? ParentExperimentType => typeof(Tuned);

            public static string ExperimentDescription => "Tagged ultra-sparse tuned probing with dual-byte fingerprints for balanced 50%-uniqueness hit/miss mixes.";
        ...
        public sealed class MissBounded : IExperimentDictionary<string>
        {
            public static string ExperimentName => "hash.linear.tagged.ultra-sparse.tuned.miss-bounded.v1";

            public static Type? ParentExperimentType => typeof(Tuned);

            public static string ExperimentDescription => "Tagged ultra-sparse tuned probing with per-home max-distance bounds to cut miss probes.";
