...
public sealed class LinearProbingHalfLoadStringDictionary : IExperimentDictionary<string>
{
    ...
    public static string ExperimentDescription => "Linear probing with 50% max load factor.";
