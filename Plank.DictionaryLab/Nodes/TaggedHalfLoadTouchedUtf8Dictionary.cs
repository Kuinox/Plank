...
public sealed class TaggedHalfLoadTouchedUtf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    public static string ExperimentName => "hash.linear.tagged.half-load.touched.v1";

    public static Type? ParentExperimentType => typeof(TaggedLinearProbingHalfLoadUtf8Dictionary);

    public static string ExperimentDescription => "UTF-8 tagged half-load probing with touched reset.";
