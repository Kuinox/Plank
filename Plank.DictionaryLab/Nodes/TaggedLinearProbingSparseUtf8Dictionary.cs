...
public sealed class TaggedLinearProbingSparseUtf8Dictionary : IExperimentDictionary<ReadOnlyMemory<byte>>
{
    public static string ExperimentName => "hash.linear.tagged.sparse.v1";

    public static Type? ParentExperimentType => typeof(TaggedLinearProbingHalfLoadUtf8Dictionary);

    public static string ExperimentDescription => "UTF-8 tagged linear probing with 35% max load.";
