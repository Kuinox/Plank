...
public sealed class TaggedSparseTouchedStringDictionary : IExperimentDictionary<string>
{
    ...
    public static string ExperimentDescription => "Tagged sparse linear probing with touched reset.";
