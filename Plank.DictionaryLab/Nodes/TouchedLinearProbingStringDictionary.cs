...
public sealed class TouchedLinearProbingStringDictionary : IExperimentDictionary<string>
{
    ...
    public static string ExperimentDescription => "Linear probing with touched-slot reset.";
    ...
    public sealed class Tagged : IExperimentDictionary<string>
    {
        public static string ExperimentName => "hash.linear.touched-reset.tagged.v1";

        public static Type? ParentExperimentType => typeof(TouchedLinearProbingStringDictionary);

        public static string ExperimentDescription => "Linear probing with touched-slot reset and one-byte tag fingerprints.";
        ...
        public sealed class HalfLoad : IExperimentDictionary<string>
        {
            ...
            public static string ExperimentDescription => "Linear probing with touched-slot reset, one-byte tags, and 50% max load.";
